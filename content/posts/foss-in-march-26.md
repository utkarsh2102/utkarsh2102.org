...
- **ruby-rack**: Path traversal and stored XSS vulnerabilities in directory handling.
  ...
  - **[bookworm]**: Fixed [CVE-2026-22860](https://security-tracker.debian.org/tracker/CVE-2026-22860) and [CVE-2026-25500](https://security-tracker.debian.org/tracker/CVE-2026-25500) via [**2.2.2-0+deb12u1**](https://tracker.debian.org/news/1735337/accepted-ruby-rack-2222-0deb12u1-source-into-oldstable-security/) for bookworm. This has been uploaded to oldstable-security and announced as [**DSA 6180-1**](https://lists.debian.org/debian-security-announce/2026/msg00089.html).
  - **[trixie]**: Fixed [CVE-2026-22860](https://security-tracker.debian.org/tracker/CVE-2026-22860) and [CVE-2026-25500](https://security-tracker.debian.org/tracker/CVE-2026-25500) via [**3.1.2-0+deb13u1**](https://tracker.debian.org/news/1735338/accepted-ruby-rack-3120-0deb13u1-source-into-stable-security/) for trixie. This has been uploaded to stable-security and announced as [**DSA 6180-1**](https://lists.debian.org/debian-security-announce/2026/msg00089.html).
